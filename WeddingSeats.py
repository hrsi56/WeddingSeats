...
.stNumberInput div[data-baseweb="input"] > div {
    background-color: #ebeded !important; /* רקע קרם בהיר מאוד */
...
.stTextInput, .stNumberInput, .stTextArea {
    ...
    /* טבלאות ו-DataFrames */
    .stDataFrame, .stTable {
        background-color: #ebeded !important; /* רקע קרם בהיר לטבלאות */
    ...
    .stDataFrame tbody tr:nth-child(even), .stTable tbody tr:nth-child(even) {
     ...
     .stDataFrame tbody tr:nth-child(odd), .stTable tbody tr:nth-child(odd) {
        background-color: #ebeded !important; /* רקע קרם בהיר לשורות אי זוגיות */
    }
    ...
    div[data-testid="stVerticalBlock"], div.stBlock { /* מתמקד בקונטיינרים של בלוקים */
        ...
        /* background-color: #ebeded; */ /* רקע קרם בהיר אם רוצים */
        /* border-radius: 10px; */
        /* padding: 1em; */ /* לדוגמה */
